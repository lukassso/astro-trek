...
<ol style="list-style-type: upper-roman; padding-left: 2em;">
  <li><a href="#wprowadzenie" style="text-decoration: underline; color: inherit;">Wprowadzenie: Od architektury frontendowej do nauki o danych</a></li>
  <li><a href="#fundamenty" style="text-decoration: underline; color: inherit;">Fundamenty technologiczne: Warsztat analityka danych w praktyce</a></li>
  <li><a href="#projekty" style="text-decoration: underline; color: inherit;">Zderzenie z rzeczywistością: Projekty i osobiste wyzwania</a></li>
  <li><a href="#synteza" style="text-decoration: underline; color: inherit;">Synteza i nowy rozdział</a></li>
  <span style="margin-left: 8px;"><a href="#bonus" style="text-decoration: underline; color: inherit;">Bonus! Przetestuj swój pomysł w generatorze pomysłów</a></span>
</ol>
