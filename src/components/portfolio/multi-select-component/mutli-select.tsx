...
export function MultiSelect({
  ...
  return (
    <div className="mx-auto w-full max-w-md">
              ...
              <div className="flex w-full items-center justify-between">
                <div className="flex flex-wrap items-center">
                  {selectedValues.slice(0, maxCount).map((value) => {
                    ...
                    return (
                      <Badge key={value} className="mr-1 flex items-center">
                  ...
                  {selectedValues.length > maxCount && (
                    <Badge>{`+ ${selectedValues.length - maxCount} more`}</Badge>
                  )}
                </div>
                <div className="flex items-center justify-between">
                  ...
                  <ChevronDown className="mx-2 h-4 cursor-pointer text-gray-950" />
                </div>
              </div>
            ) : (
      ...
      >
        <div className={cn(isMobile && "flex h-screen flex-col")}>
          <CommandInput
            placeholder="Search or select options..."
            className={cn(isMobile && "h-14")}
          />
          {selectedValues.length > 0 && (
          ...
          <CommandList className={cn(isMobile && "max-h-[80vh] flex-1")}>
            <CommandEmpty>No results found.</CommandEmpty>
