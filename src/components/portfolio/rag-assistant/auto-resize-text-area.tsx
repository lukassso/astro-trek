  ...
  ({ className, ...props }, ref) => {
    ...
    return (
      <Textarea
        ...
        className={cn(
          "focus:ring-offset-0 focus-visible:ring-offset-0 min-h-[40px] overflow-hidden border-0 shadow-none focus:outline-none focus:ring-0 focus-visible:outline-none focus-visible:ring-0",
          className,
        )}
        rows={1}
      />
