...
export default function Form({ isLoading, onSubmit, onOpenOptions }: FormProps) {
  ...
  const { images, addImages, removeImage, error, dragCounter, handleDragEnter, handleDragLeave, handleDrop } = useImageUpload()
  ...
  return (
    <FormProvider {...form}>
      <form ref={formRef} onSubmit={form.handleSubmit(onSubmit)} className="relative">
        ...
        >
          <ImageUploadArea previewUrls={images.map(img => img.previewUrl)} onRemoveImage={removeImage} isLoading={isLoading} />
          ...
          <div className="px-2 py-1.5">
            <div className="flex items-center">
              ...
              <Button type="button" variant="ghost" size="icon" onClick={onOpenOptions} disabled={isLoading}>
              ...
              <AutoResizeTextarea
                ...
                disabled={isLoading}
              />
              <Button type="submit" disabled={isLoading} className="bg-white hover:bg-gray-200 text-black rounded-full h-10 w-10 p-0 flex items-center justify-center">
