...
const pagesData: Record<string, PageData> = {
  index: {
    ...
    og: {
      ...
      description:
        "Explore my portfolio of custom web apps and AI projects. From full JS applications to AI prototypes, see how I can help your business grow.",
  ...
  blog: {
    ...
    description:
      "Web development insights, programming tutorials, and experiments with AI. Explore articles on modern web technologies.",
    og: {
  ...
  "bank-transactions": {
    ...
    description:
      "An interactive dashboard to view, add, and search bank transactions. A live demo showcasing React, TypeScript, and modern state management.",
    og: {
  ...
  "playground-ai": {
    ...
    description:
      "Experiment with OpenAI's ChatGPT through a user-friendly interface. Adjust model settings and see interactive AI responses in real-time.",
    og: {
  ...
  "firebase-auth": {
    ...
    description:
      "A complete sign-in, sign-up, and password reset flow built with Firebase Authentication. A practical example for modern web apps.",
    og: {
  ...
  "framer-parallax": {
    ...
    description:
      "See a beautiful and smooth parallax scrolling effect in action. A demonstration of the Framer Motion animation library in a React/Astro project.",
    og: {
  ...
  "hacker-news": {
    ...
    description:
      "A fast and clean client for browsing Hacker News. A practical example of fetching and displaying data from a REST API.",
    og: {
  ...
  "movie-app": {
    ...
    description:
      "Browse, search, and discover movies using the TMDB API. A feature-rich demo showcasing React Query, routing, and complex state management.",
    og: {
  ...
  "multi-select": {
    ...
    description:
      "An accessible, reusable, and powerful multi-select component for React, built with Radix UI and Tailwind CSS.",
    og: {
  ...
  "nbp-currency-explorer": {
    ...
    description:
      "Analyze and visualize historical currency exchange rates from the National Bank of Poland (NBP) API with interactive charts.",
    og: {
  ...
  "rag-assistant": {
    ...
    description:
      "A proof-of-concept AI assistant using the RAG (Retrieval-Augmented Generation) pattern to answer questions from a custom knowledge base.",
  },
  "random-person": {
    title: "Random Person Profile Generator",
    description:
      "A simple but useful tool for developers and testers to generate random user profiles for testing purposes.",
    og: {
  ...
  "svg-anime-universe": {
    ...
    description:
      "An example of complex and performant SVG animations used to create a dynamic and engaging user interface.",
    og: {
  ...
  "task-manager": {
    ...
    description:
      "A classic task manager to demonstrate state management with Redux or Context API.",
    og: {
  ...
  "url-scraper": {
    ...
    description:
      "A demonstration of a web scraper application that can extract data, like titles and meta tags, from a given URL.",
  },
  "webcam-object-detection": {
    title: "Real-Time Object Detection in Browser",
    description:
      "Using your webcam, this app performs real-time object detection directly in the browser with TensorFlow.js.",
  },
  "webcam-pose-detection": {
    title: "Real-Time Pose Detection in Browser",
    description:
      "A web app using TensorFlow.js to perform real-time human pose detection and estimation in the browser.",
    og: {
...
function generatePageSeo(slug: string): SeoProps {
  ...
  const ogImageUrl = pageData.og?.imageUrl
    ? new URL(pageData.og.imageUrl, SITE_URL).href
